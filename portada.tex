% !TeX root = TI_Paniagua_Daniel.tex
%----------------------------------------------------------------------------------------
% PORTADA
%----------------------------------------------------------------------------------------
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Optimización y despliegue de modelos de demanda de energía eléctrica de Argentina} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Daniel Gerardo Paniagua} \\[1cm]
        ...
        \textbf{Director:} Esp. Ing. Joel Alexander Spak (Nasini S.A.)} \\[1cm]
